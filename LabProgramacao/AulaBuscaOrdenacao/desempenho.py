...
def main():
    ...
    for n in tamanho:
        ...
        lista = gerar_lista(n)
        tempo_bolha = medir_tempo(util.OrdenarListaBubble, lista)
        tempo_selecao = medir_tempo(util.ordenarSelec, lista)
        tempo_insercao = medir_tempo(util.ordenarInsert, lista)
        tempo_quickSort = medir_tempo(util.ordenarQuicksort, lista)
